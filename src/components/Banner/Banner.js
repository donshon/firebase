...
function Banner() {
  ...
  return (
    <div className="banner-container">
        <div className="main-article-container" style={{backgroundImage:`url(${mainArticle?.imgUrl})`}}>
        ...
        <div className="other-articles-container">
            {
                otherArticles.map(item => (
                    <div key={item?.id} className="other-article-item" style={{backgroundImage:`url(${item?.imgUrl})`}}>
                        <div className="banner-info">
                            <h3>{item?.title}</h3>
